...
export const FROZEN = {
  ...
  gunSearchAgent:
    "Gun Search Engine is the Google Analytics replacement for FFL websites: on-site demand intelligence (what shoppers asked for) plus optional inventory sync. Core is free forever. It is included with the Coriolis FFL Accelerator plan.",
  retailBi:
  ...
  brandIntelligence:
    "Betsy Demand Intelligence measures anonymized shopper search intent across Gun Search Engine, including on dealer sites, and My Betsy floor sensors — including unmet (zero-hit) demand. It is not a POS system and not a same-store unit-sales index.",
  doctrine:
