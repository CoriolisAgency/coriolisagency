/**
 * Entity-kit frozen strings. Copy; do not rewrite for voice.
 * Source: gunsearchengine/docs/entity-kit.md (via fflaccelerator).
 */
export const FROZEN = {
  fflAccelerator:
  ...
  gunSearchAgent:
    "GunSearchAgent is the Google Analytics replacement for FFL and 2A websites: on-site demand intelligence (what shoppers asked for) plus optional inventory sync. Core is free forever. GunSearchAgent Pro is included with the Coriolis FFL Accelerator plan.",
  retailBi:
  ...
  brandIntelligence:
    "Betsy Demand Intelligence measures anonymized shopper search intent across GunSearchEngine.com, the GunSearchAgent.com sensor, and My Betsy floor sensors — including unmet (zero-hit) demand. It is not a POS system and not a same-store unit-sales index. (Formerly Brand Intelligence.)",
  doctrine:
